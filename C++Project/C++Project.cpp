...
//void checkBuyer(const Book& book, const Student& student) {
//
//    for (const auto& buyer : book.buyers)
//    {
//        if (buyer == student.surname)
//        {
//            cout << "Student: " << buyer << "has already bought this book " << book.title << std::endl;
//        }
//    }
//
//};
...
int main()
{
 ...
 /*   cout << "Student 1: " << student1.getSurname() << ", " << student1.getName() << ", " << student1.getSecondName() << ", " << student1.getFaculty() << ", " << student1.getCourse() << endl;
  ...
  /*  Book firstBook("George Orwell", "1984", "Penguin Books", 1949, 328);
   ...
   /* vector<string> buyers = { "Homenko", "Haschenko", "Petrenko" };

    Book bookFrom6Lab("Roling", "1984", "Best Publisher", 2023, 200, buyers);

    Student studentFrom6Lab("Petrenko", "Ivan", "Ivanovich", "01-01-2000", "Some Address", 123456789, "Computer Science", 1);*/

    //checkBuyer(bookFrom6Lab, studentFrom6Lab);

    //studentFrom6Lab.Show(bookFrom6Lab);

    //  OOP 7 

    /*Завдання 1*/

    Abiturient ab1("Surname1", "FirstName1", "MiddleName1", "Address1", 3);
    Abiturient ab2("Surname2", "FirstName2", "MiddleName2", "Address2", 3);

    // до використання оператора привласнення
    cout << "Before assignment:" << endl;
    cout << "Abiturient 1:" << endl;
    ab1.printObjectAddress();
    ab1.printArrayAddress();

    cout << "Abiturient 2:" << endl;
    ab2.printObjectAddress();
    ab2.printArrayAddress();


    ab2 = ab1;

    //  після використання оператора привласнення
    ...
    Number firstObject(10, 34); 
    Number secondObject(5, 5);

    Number resultAddition = firstObject + secondObject;
    Number resultSubtraction = firstObject - secondObject;
    Number resultMultiplication = firstObject * secondObject;
    Number resultDivision = firstObject / secondObject;


    // Додавання, віжнімання, ділення, множення  
    cout << "Addition: ";
    ...
    // Перевантажені оператори інкременту і декременту
